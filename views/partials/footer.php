...
<div style="display:flex; justify-content: center;" id="footerjetv">
    <div class="container" style="margin:0px;width:100% !important;">
                ...
                <div class="container" style="width:100% !important; padding:0px !important;">
                    <div class="row">
                        <div class="col-sm">
                            ...
                            <a href="https://www.x.com" style="color: white;" target="_blank">
                        ...
                        <div class="col-sm">
                            ...
                            <a href="https://www.instagram.com" style="color: white;" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                        ...
                        <div class="col-sm">
                            ...
                            <a href="https://www.youtube.com" style="color: white;" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
...
<?php if (!isset($doNotRefresh)): ?>
    ...
    <script>
        ...
        let panel = new AutoRefreshedPanel("refreshMain", "<?= $_SERVER['REQUEST_URI'] ?>", 10)
    </script>
<?php endif ?>
